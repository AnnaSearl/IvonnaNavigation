 ...
 */
@Navigator.Name("ivonnafragment")
public class IvonnaFragmentNavigator extends FragmentNavigator {
    private static final String TAG = "IvonnaFragmentNavigator";
    private Context mContext;
    private FragmentManager mManager;
    private int mContainerId;

    public IvonnaFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager, int containerId) {
